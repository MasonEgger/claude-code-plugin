...
description: This skill should be used when writing step-by-step technical tutorials, creating documentation for code or applications, explaining technical concepts procedurally, or working with Temporal application tutorials. Triggers include "write a tutorial", "help me write documentation", "create a how-to guide", "write up this code", or "tutorial for this application". Follows a modified DigitalOcean style with friendly-but-formal tone, code sandwich approach, comprehensive explanations assuming English is the reader's second language, and never generates new code (only references provided code).
---
...
* Flesch Reading Ease Score of 70 or above
